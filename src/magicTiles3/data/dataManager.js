...
import level2_2 from "../../../assets/jsons/level2-2.json";
import level2_3 from "../../../assets/jsons/level2-3.json";
import level2_4 from "../../../assets/jsons/level2-4.json";
import level2_5 from "../../../assets/jsons/level2-5.json";
import level2_6 from "../../../assets/jsons/level2-6.json";
import level2_7 from "../../../assets/jsons/level2-7.json";
...
export class DataManager {
  static init() {
    ...
    this.levelDatas.push(level2_2);
    this.levelDatas.push(level2_3);
    this.levelDatas.push(level2_4);
    this.levelDatas.push(level2_5);
    this.levelDatas.push(level2_6);
    this.levelDatas.push(level2_7);
